...
public class DoctorController {
    ...
    public boolean addUser(@RequestBody DoctorModel doctor) {
	...
	public MappingJacksonValue getDoctorInformation(@PathVariable String name) {
		DoctorModel doctor = service.showDoctorInformation(name);
	...
	public DoctorModel getDoctorInfo(@PathVariable String name) {
		DoctorModel doctor = service.showDoctorInformation(name);
		return doctor;
	}
	...
	public MappingJacksonValue getListOfDoctor() {
		List<DoctorModel> doctors = service.getDoctors() ;
